...
# You are sat with two frogs on a log, Chris and Tom. They are arguing about who ate the most flies (Poor flies, but what you going to do!). Chris says "
...
# Cat then hops onto the log looking pleased with herself "Well, I ate the summation of both your dinners combined." Loz who came late to this meeting 
...
def frog_contest(flies):
    ...
    tom = int((half*(half+1))/2)
    
    sum_cat = chris + tom

    cat = int((sum_cat*(sum_cat+1))/2)
